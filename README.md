...
python3 -m scripts.csv2db --input merged.csv --tables Input --custom initial_labeled_tweet --db backend.db
python3 -m scripts.csv2db --input merged.csv --tables Output --custom initial_labeled_tweet --db backend.db
```